...
(function(){
  ...
  const STR = {
    en: {
      ...
      signupSub:'Save your Pet Persona, get matched, and bring them home.',
      ...
      breederBannerSub:'Every breeder will pass a 38-point audit — facilities, lineage, vet records, and ethics. Onboarding founding farms now.',
    ...
    th: {
      ...
      signupSub:'บันทึก Pet Persona รับการจับคู่ และพาเขากลับบ้าน',
      ...
      breederBannerSub:'ทุกฟาร์มจะผ่านการตรวจสอบ 38 หัวข้อ — สถานที่ สายพันธุ์ ประวัติสัตวแพทย์ และจริยธรรม กำลังรับสมัครฟาร์มผู้ก่อตั้ง',
